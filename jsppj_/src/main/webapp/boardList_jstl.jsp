...
<tr>
<td>${pm.totalCount -((status.index) +(pm.searchCri.page-1)*pm.searchCri.perPageNum) } </td>
<td>${bv.bidx}</td>
<td>
...
<a href="${pageContext.request.contextPath}/board/boardList.do?page=${pm.startPage-1}&searchType=${pm.searchCri.searchType}&keyword=${pm.encoding(pm.searchCri.keyword)}">◀</a>
</c:if>
</td>
<td style="text-align:center;width:300px;">
<c:forEach begin="${pm.startPage}" end="${pm.endPage}"  step="1"  var="i">
<a href=" ${pageContext.request.contextPath}/board/boardList.do?page=${i}&searchType=${pm.searchCri.searchType}&keyword=${pm.encoding(pm.searchCri.keyword)}">${i}</a>
</c:forEach>
</td>
<td style="width:200px;text-align:left;">
<c:if test="${pm.next&&pm.endPage >0 }">
<a href="${pageContext.request.contextPath}/board/boardList.do?page=${pm.endPage+1}&searchType=${pm.searchCri.searchType}&keyword=${pm.encoding(pm.searchCri.keyword)}">▶</a>
</c:if>
</td>
</tr>
</table>
